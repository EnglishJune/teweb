      ...
      <div class="page-shell">
        ...
        <main v-else>
          <section class="notice-panel" aria-labelledby="news-heading">
            ...
            <p><span style="color: #FF0000;">!!! 我正在做 AI 辅助英语学习，目前集中在《经济学人》周刊的阅读笔记和播客的口语分析，亟需使用这些材料实际学习的反馈，相关学习视频和资料在我的B站，恳请大家给我实际使用、学习反馈，希望我们一起把“免费学习”、“AI辅助学习“做得更好！微信/邮件都可！每周提供3篇文章/2个播客学习反馈的，我将提供更多你需要的学习资料或AI支持作为回馈！</span></p>
